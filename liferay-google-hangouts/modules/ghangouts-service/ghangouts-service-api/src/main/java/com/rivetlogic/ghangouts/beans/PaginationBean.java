...
public class PaginationBean {
	...
	protected OrderByComparator<HangoutsGroup> obc;
	protected int start;
	protected int end;
	...
	public PaginationBean(){
		...
		end = Constants.DEFAULT_DELTA;
		curPage = Constants.DEFAULT_ELEMENT_VALUE;
		delta = end;
	}
	
	public OrderByComparator<HangoutsGroup> getObc() {
		return obc;
	}
	...
	public void setObc(OrderByComparator<HangoutsGroup> obc) {
		this.obc = obc;
	}
