...
public class HangoutsGroupCacheModel implements CacheModel<HangoutsGroup>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof HangoutsGroupCacheModel)) {
			return false;
		}

		HangoutsGroupCacheModel hangoutsGroupCacheModel = (HangoutsGroupCacheModel)obj;

		if (hangoutsGroupId == hangoutsGroupCacheModel.hangoutsGroupId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, hangoutsGroupId);
	}
